...
<div class="wp-block-group alignfull has-primary-bg-background-color has-background" style="padding-top:80px;padding-right:20px;padding-bottom:80px;padding-left:20px">
	...
	<div class="wp-block-group">
		...
		<!-- wp:heading {"level":1} -->
		<h1 class="wp-block-heading">Our <span class="hero-title-accent">Services</span></h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph -->
		<p>From Shopify storefronts to custom web applications — precision engineering for every project.</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
