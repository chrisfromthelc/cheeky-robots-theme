...
<div class="wp-block-group alignfull has-primary-bg-background-color has-background" style="padding-top:80px;padding-right:20px;padding-bottom:80px;padding-left:20px">
	...
	<div class="wp-block-group">
		...
		<p class="section-tag">Our Portfolio</p>
		<!-- /wp:paragraph -->

		<!-- wp:heading {"level":1} -->
		<h1 class="wp-block-heading">Our <span class="hero-title-accent">Work</span></h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph -->
		<p>A selection of recent projects — each one built with obsessive attention to detail.</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
